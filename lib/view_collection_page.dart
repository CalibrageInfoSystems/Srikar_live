...
class _ViewCollectionPageState extends State<ViewCollectionPage> {
        // String url = 'http://182.18.157.215/Srikar_Biotech_Dev/API/api/Collections/GetCol  lections/null';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (json['response']['listResult'] != null) {
          ...
          debugPrint('_______view collection____listResult___${listResult}');
